     ...
     c** Fill 12 buckets of data with this year PO Receipts histype 1
     c                   exsr      $_clear
     c                   exsr      $_buckets_1

     c** Fill 12 buckets of data with last year PO Receipts histype 1
     c                   exsr      $_clear
     c                   exsr      $_buckets_2
     ...
     c                   eval      zz_varytx3 = last_yearD + ' PO Receipts ' +
     ...
     c                   eval      zz_varytx4 = this_yearD + ' PO Receipts ' +
     ...
     c**                 when      pr_forcper = 1
     c**                 eval      bucket01_1= %trimr(%editc(lastyear01:'3'))
     ...
     c***-- Newer products; don't start showing until we hit
     c***-- the PR_FSTSLYR/PR_FSTSLPR
     c                   eval      findyear = %subdt(%date():*years)

     c*** First sale is this year
     c                   if        pr_fstslyr = findyear
     ...
     c                   eval      bucket01_2= %trimr(%editc(lastyear01:'3'))
     ...
     c***--------- 2021 fix ---- START-----------------------------
     c*** Temporary fix for 2021...our first bucket of this data
     c*** for histype 2 was June 2021..so blank out all buckets before
     c*** June 2021
     c**                 if        pr_forcyr = 2021
