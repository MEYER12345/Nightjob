     ...
     d hcactbuyr       s              5    inz('928  ')
     d hcactuser       s             10    inz('KING3BBAL1')
     d hcreqtype       s              3    inz('Q11')
     d hcstatus        s              1    inz('O')
     d hcdescr         s             30    inz('Products with reduced averages')
     d hccrtuser       s             10    inz('K3S_3202')
