      ...
      *   Programmer. David Meyer.
      *   Date. 04/15/2022.
      *   Remarks. Per K3 I added code to write K_PRODFOR data to
      *      file PRODFORERR (Errors reading CHUY transactions) when an
      *      error condition occurs while reading the K_PRODFOR records
      *      with PF_CHGTYPE = 'C', 'H', 'U', or 'Y'.
      *********************************************************************
